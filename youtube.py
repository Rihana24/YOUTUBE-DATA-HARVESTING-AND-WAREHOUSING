...
#API key connection
def Api_connect():
    Api_Id="AIzaSyAuvl2ZxL6_uTcBqCo1BtZXchwzDUpOg0c"
...
client=pymongo.MongoClient("mongodb+srv://rihanaparveen:rihanap@cluster0.yy5gqa1.mongodb.net/?retryWrites=true&w=majority")
